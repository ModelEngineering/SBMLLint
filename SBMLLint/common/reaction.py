...
class Reaction(object):
  ...
  def _getCategory(self):
    ...
    num_reactants = sum([r.stoichiometry for r in self.reactants if r.name!=cn.EMPTYSET])
    num_products = sum([p.stoichiometry for p in self.products if r.name!=cn.EMPTYSET])
